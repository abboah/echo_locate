...
class AppRoutes {
  ...
  /// A building: its floors, their state, and what to do with each.
  ///
  /// There was a separate `/building/:id` detail screen in front of this one —
  /// a hero, a room list read from a table nothing writes to, and a button
  /// through to the floors. It is gone; this path opens the floors directly.
  static const String building = '/building/:id';
  ...
  /// Kept as an alias of [building] so links written against the old name
  /// still resolve. Both open the same screen.
  static const String buildingMapping = building;
