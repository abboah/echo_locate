...
## Design tokens
Coral `#FB5B47` (single accent) · Ink `#1C1B1A` · Surface `#F6F5F2` · White `#FFFFFF`. Type: Hanken Grotesk. Rounded cards, soft shadows, one warm accent, white surfaces. Bottom nav: Home · Explore · [center Scan FAB] · Maps · Profile. Figma file: `MGYeyWGqLMH3rSaabjvfvI`.
